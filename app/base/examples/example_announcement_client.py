...
from app.models.announcements import Announcements, Post
from app.base.base_announcement_client import BaseAnnouncementClient
...
class SQLAlchemyAnnouncementClient(BaseAnnouncementClient):
    ...
    def get_posts(self) -> Announcements:
        """
        Returns an instance of app.models.announcements.Announcements, which should match
        app.models.announcements.AnnouncementsSchema
        """
        session = sessionmaker(bind=self.engine)()
